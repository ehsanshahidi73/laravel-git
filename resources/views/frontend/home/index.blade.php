...
@section('content')
    <div class="row">
        ...
        {{--     <div class="marketshop-banner">
                 <div class="row">
                     <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12"><a href="#"><img src="/frontend/image/banner/sample-banner-3-300x300.jpg" alt="بنر نمونه 2" title="بنر نمونه 2" /></a></div>
                     <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12"><a href="#"><img src="/frontend/image/banner/sample-banner-1-300x300.jpg" alt="بنر نمونه" title="بنر نمونه" /></a></div>
                     <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12"><a href="#"><img src="/frontend/image/banner/sample-banner-2-300x300.jpg" alt="بنر نمونه 3" title="بنر نمونه 3" /></a></div>
                     <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12"><a href="#"><img src="/frontend/image/banner/sample-banner-4-300x300.jpg" alt="بنر نمونه 4" title="بنر نمونه 4" /></a></div>
                 </div>
             </div>--}}
        <!-- Banner End-->
            <!-- محصولات Tab Start -->
            <div id="product-tab" class="product-tab">
                    ...
                    <div class="owl-carousel product_carousel_tab">
                        @foreach($latestProduct as $product)
                            <div class="product-thumb clearfix">
                                <div class="image"><a href="{{route('product.single',['slug'=>$product->slug])}}"><img
                                            src="{{$product->photos[0]->path}}"
                                            alt="تی شرت کتان مردانه" title="تی شرت کتان مردانه" class="img-responsive"/></a>
                                </div>
                                <div class="caption">
                    ...
                    <div class="owl-carousel product_carousel_tab">
                        ...
                        <div class="product-thumb">
                            <div class="image"><a href="product.html"><img
                                        ...
                                        alt="محصولات مراقبت از مو" title="محصولات مراقبت از مو" class="img-responsive"/></a>
                            </div>
                            <div class="caption">
                        ...
                        <div class="product-thumb">
                            <div class="image"><a href="product.html"><img
                                        src="/frontend/image/product/nikon_d300_4-220x330.jpg" alt="کرم لخت کننده مو"
                        ...
                        <div class="product-thumb">
                            <div class="image"><a href=""><img src="/frontend/image/product/macbook_5-220x330.jpg"
                ...
                <div id="tab-special" class="tab_content">
                    <div class="owl-carousel product_carousel_tab">
                        <div class="product-thumb">
                            <div class="image"><a href="product.html"><img
                                        src="/frontend/image/product/ipod_touch_1-220x330.jpg" alt="سامسونگ گلکسی s7"
                        ...
                        <div class="product-thumb">
                            <div class="image"><a href="product.html"><img
                                        src="/frontend/image/product/macbook_air_1-220x330.jpg" alt="لپ تاپ ایلین ور"
                        ...
                        <div class="product-thumb">
                            <div class="image"><a href="product.html"><img
                                        ...
                                        alt=" کتاب آموزش باغبانی " title=" کتاب آموزش باغبانی " class="img-responsive"/></a>
                            </div>
                            <div class="caption">
                        ...
                        <div class="product-thumb">
                            <div class="image"><a href="product.html"><img
                                        src="/frontend/image/product/samsung_tab_1-220x330.jpg" alt="تبلت ایسر"
                ...
                <div class="category-module-content">
                    ...
                    <div id="tab-cat1" class="tab_content">
                        <div class="owl-carousel latest_category_tabs">
                            @foreach($motorCategory as $motor)
                                <div class="product-thumb">
                                    <div class="image"><a href="product.html"><img
                                                src="{{$motor->photos[0]->path}}" alt="تبلت ایسر"
                                                title="تبلت ایسر" class="img-responsive"/></a></div>
                                    <div class="caption">
                                        <h4><a href="product.html">{{$motor->title}}</a></h4>
                                        <p class="price"><span class="price-new">98000 تومان</span> <span class="price-old">240000 تومان</span>
                                            <span class="saving">-5%</span></p>
                                        <div class="rating"><span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i><i
                        ...
                        <div class="owl-carousel latest_category_tabs">
                            <div class="product-thumb">
                                <div class="image"><a href="product.html"><img
                                            ...
                                            alt="لپ تاپ hp پاویلیون" title="لپ تاپ hp پاویلیون" class="img-responsive"/></a>
                                </div>
                                <div class="caption">
                        ...
                        <div class="owl-carousel latest_category_tabs">
                            ...
                            <div class="product-thumb">
                                <div class="image"><a href="product.html"><img
                                            ...
                                            alt="سامسونگ گلکسی s7" title="سامسونگ گلکسی s7" class="img-responsive"/></a>
                                </div>
                                <div class="caption">
                                    <h4><a href="product.html">سامسونگ گلکسی s7</a></h4>
                                    <p class="price"><span class="price-new">62000 تومان</span> <span class="price-old">122000 تومان</span>
                            ...
                            <div class="product-thumb">
                                <div class="image"><a href="product.html"><img
                                            ...
                                            alt="موبایل HTC M7" title="موبایل HTC M7" class="img-responsive"/></a></div>
                                <div class="caption">
                    ...
                    <div id="tab-cat5" class="tab_content">
                        <div class="owl-carousel latest_category_tabs">
                            ...
                            <div class="product-thumb">
                                <div class="image"><a href="product.html"><img
                                            src="/frontend/image/product/ipod_classic_1-220x330.jpg" alt="آیپاد نسل 5"
                            ...
                            <div class="product-thumb">
                                <div class="image"><a href="product.html"><img
                                            src="/frontend/image/product/macbook_1-220x330.jpg" alt="آیدیا پد یوگا"
                            ...
                            <div class="product-thumb">
                                <div class="image"><a href="product.html"><img
                                            src="/frontend/image/product/ipod_nano_1-220x330.jpg" alt="پخش کننده موزیک"
            ...
            <div class="owl-carousel latest_category_carousel">
                <div class="product-thumb">
                    <div class="image"><a href="product.html"><img src="/frontend/image/product/iphone_6-220x330.jpg"
                ...
                <div class="product-thumb">
                    <div class="image"><a href="product.html"><img
                                src="/frontend/image/product/nikon_d300_5-220x330.jpg" alt="محصولات مراقبت از مو"
                ...
                <div class="product-thumb">
                    <div class="image"><a href="product.html"><img src="/frontend/image/product/macbook_4-220x330.jpg"
                ...
                <div class="product-thumb">
                    <div class="image"><a href="product.html"><img src="/frontend/image/product/macbook_3-220x330.jpg"
                ...
                <div class="product-thumb">
                    <div class="image"><a href="product.html"><img src="/frontend/image/product/macbook_2-220x330.jpg"
            ...
            <div id="carousel" class="owl-carousel nxt">
                <div class="item text-center"><a href="#"><img src="/frontend/image/product/apple_logo-100x100.jpg"
                                                               alt="پالم" class="img-responsive"/></a></div>
                <div class="item text-center"><a href="#"><img src="/frontend/image/product/canon_logo-100x100.jpg"
