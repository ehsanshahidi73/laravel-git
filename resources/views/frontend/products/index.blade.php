                    ...
                    <div class="row product-info">
                        <div class="col-sm-6">
                            <div class="image"><img class="img-responsive" itemprop="image" id="zoom_01"
                                                    src="{{$product->photos[0]->path}}" title="لپ تاپ ایلین ور"
                                                    alt="لپ تاپ ایلین ور"
                            ...
                            <div class="image-additional" id="gallery_01">
                                @foreach($product->photos as $photo)
                                    <a class="thumbnail" href="#" data-zoom-image="{{$photo->path}}"
                                       data-image="{{$photo->path}}" title="لپ تاپ ایلین ور">
                                        <img src="{{$photo->path}}" title="لپ تاپ ایلین ور" alt="لپ تاپ ایلین ور"/>
                                    </a>
                                @endforeach
                            </div>
                        </div>
            ...
            <aside id="column-right" class="col-sm-3 hidden-xs">
                ...
                <div class="side-item">
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="/frontend/image/product/apple_cinema_30-50x75.jpg" alt="تی شرت کتان مردانه"
                    ...
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img src="/frontend/image/product/iphone_1-50x75.jpg"
                    ...
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img src="/frontend/image/product/macbook_1-50x75.jpg"
                    ...
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="/frontend/image/product/sony_vaio_1-50x75.jpg" alt="کفش راحتی مردانه"
                    ...
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="/frontend/image/product/FinePix-Long-Zoom-Camera-50x75.jpg"
                                    alt="دوربین فاین پیکس" title="دوربین فاین پیکس" class="img-responsive"/></a></div>
                        <div class="caption">
                ...
                <div class="side-item">
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="/frontend/image/product/macbook_pro_1-50x75.jpg" alt=" کتاب آموزش باغبانی "
                    ...
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="/frontend/image/product/samsung_tab_1-50x75.jpg" alt="تبلت ایسر"
                                    title="تبلت ایسر" class="img-responsive"/></a></div>
                        <div class="caption">
                            <h4><a href="product.html">تبلت ایسر</a></h4>
                            <p class="price"><span class="price-new">98000 تومان</span> <span class="price-old">240000 تومان</span>
                    ...
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="/frontend/image/product/nikon_d300_1-50x75.jpg" alt="دوربین دیجیتال حرفه ای"
                    ...
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="/frontend/image/product/nikon_d300_5-50x75.jpg" alt="محصولات مراقبت از مو"
                    ...
                    <div class="product-thumb clearfix">
                        <div class="image"><a href="product.html"><img
                                    src="/frontend/image/product/macbook_air_1-50x75.jpg" alt="لپ تاپ ایلین ور"
