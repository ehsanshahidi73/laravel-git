                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        @foreach($cart->items as $product)
                            <tr>
                                <td class="text-center" width="9%"><a href="product.html"><img
                                ...
                                <td class="text-left">
                                    <div class="input-group btn-block quantity">
                                        <a data-toggle="tooltip" title="اضافه"
                                           href="{{route('cart.add',['id'=>$product['item']->id])}}"
                                           class="btn btn-primary"><i class="fa fa-plus"></i></a>
                                        <button type="button" data-toggle="tooltip" title="حذف" class="btn btn-danger"
                                                onclick="event.preventDefault();
                                                    document.getElementById('remove-cart-item-{{$product['item']->id}}').submit();">
                                            <i
                                                class="fa fa-minus"></i></button>
                                        <form id="remove-cart-item-{{$product['item']->id}}"
                                    ...
                                    <form id="coupon-form" action="{{ route('coupon.add') }}" method="post">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button type="submit"
                                                        class="btn btn-primary">اعمال کوپن
                                                </button>
                                         </span>
                                        </div>
                                    </form>
                ...
                {{--<div class="col-sm-6">
                    <div class="panel panel-default">
                        ...
                        <div id="collapse-voucher" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <label class="col-sm-4 control-label" for="input-voucher">کد کارت هدیه را در اینجا
                                    وارد کنید</label>
                                <div class="input-group">
                                    <input type="text" name="voucher" value=""
                                           placeholder="کد کارت هدیه را در اینجا وارد کنید" id="input-voucher"
                                           class="form-control"/>
                                    <span class="input-group-btn">
